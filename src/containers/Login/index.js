                    ...
                    <div className="modal-body" >
                        ...
                        <form className="form-horizontal" onSubmit={this.handleSubmit.bind(this)} noValidate>
                            <div className="form-group"> 
                              <input type="text" className={ this.validatorCalss(name) } placeholder="用户名/邮箱" {...name} /> 
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                              ...
                              <Link  className="c-btn-forgot" to="/reset">忘记密码 ?</Link>
                            </div>
                        </form>
                          ...
                          <ul className="c-content-list-adjusted">
                             {/* <li style={{textAlign:'center',fontSize:'12px', color:'#0078B6' }}>
                              ...
                              {sns.logins.map((item,i)=>
                                <li key={i} style={{textAlign:'center',fontSize:'26px', color:'#0078B6' }} onClick={this.handleSnsLogin.bind(this,item)}>
