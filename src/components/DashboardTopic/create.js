...
class DashboardAddTopic extends Component {
  constructor(props){
    super(props)
  }
  ...
  static fetchData(params){
    return [Actions.getTagList({type:'topic'})]
  }
  ...
  render() {
    const { msg, actions, tagList, fields: { title, price, description, img, top, tags, url, tburl, sns,  password, score, defaultCollects}, dirty,invalid, resetForm } = this.props
        ...
        <div className="am-cf am-padding">
          <div className="am-fl am-cf">
            <Link to='/dashboard/topics'>
              <strong className="am-text-primary am-text-lg">主题Topic</strong> / <small>新增</small>
            </Link>
          </div>
        </div>
...
export default reduxForm({
  form: 'topic',
  fields: ['title', 'price', 'description', 'img', 'top', 'tags', 'score', 'url', 'tburl', 'sns', 'password', 'defaultCollects'],
  initialValues:{}
})(DashboardAddTopic);